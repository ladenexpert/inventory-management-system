...
final class UsageHistoryTable extends PowerGridComponent
{
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ->add('id')
            ->add('usage_number', fn (SaleItemBatch $model) => $model->usage_number ?? $model->saleItem?->sale?->invoice_number ?? '-')
            ...
            ->add('project', fn (SaleItemBatch $model) => $model->project_value ?? $model->saleItem?->sale?->project ?? '-')
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Usage No.', 'usage_number', 'sales.invoice_number')->searchable()->sortable(),
            Column::make('Date', 'usage_date', 'usage_date_value')->sortable(),
            Column::make('SKU', 'sku', 'products.sku')->searchable()->sortable(),
            Column::make('Item Code IERP', 'item_code_ierp', 'products.item_code_ierp')->searchable()->sortable(),
            Column::make('Material / Product Name', 'material_name', 'products.name')->searchable()->sortable(),
            Column::make('Batch', 'batch_number', 'batches.batch_number')->searchable()->sortable(),
            ...
            Column::make('Project', 'project', 'sales.project')->searchable(),
            Column::make('Requested By', 'requested_by', 'sales.requested_by')->searchable(),
